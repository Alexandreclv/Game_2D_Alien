...
class AlienInvasion:
    ...
    def _check_events(self):
        """Responde a eventos de pressionamento de teclas e mouse (fechamento de tela)."""
    ...
    def _remove_offscreen_bullets(sef) -> None:
    ...
    def _check_fleet_edges(self) -> None:
        """Responmde apropriadamente se algum alienígena tiver alcançado uma borda."""
